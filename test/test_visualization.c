...
void test_validate_visualization(void) {
    ...
    cJSON_AddStringToObject(viz_data, "output", "../test/data/visualization/");
...
void test_package_visualization(void) {
    ...
    res = file_exists("../test/data/visualization/provinces.geojson");
    TEST_ASSERT_TRUE(res);

    res = file_exists("../test/data/visualization/visualization.json");
    TEST_ASSERT_TRUE(res);
}
