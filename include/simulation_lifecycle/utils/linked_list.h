 ...
 * @param[in] p_data pointer to data to be stored by list node.
 * @param[in] data_size size of the data to be stored by list node.
 * @param[in] p_prev pointer to previous list node.
 * @param[in] p_next pointer to next list node.
 ...
 * @param[in] pp_head pointer to the first element of the list.
 ...
 * @param[in] pp_head pointer to the list.
 ...
 * @param[in] pp_head pointer to the list.
 * @param[in] n item number to be returned.
 ...
 * @param[in] pp_head pointer to the list.
 * @param[in] p_data pointer to value to be added to the list.
 * @param[in] data_size size (in bytes) of the data structure to be added to the list.
 */
