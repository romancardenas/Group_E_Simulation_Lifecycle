...
/**
 * @brief Creates JSON configuration file for running a Cadmium Cell-DEVS simulation. Pointers must not be null.
 ...
 */
int build_simulation_scenario(const cJSON *simulation_config, node_t **data_sources);

/**
 * @brief Runs the simulation and copy the results in the result output path indicated in the JSON configuration file.
