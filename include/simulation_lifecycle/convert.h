 ...
 * @param path_results string containing the path to the results folder.
 * @param json_filename string containing the .json filename.
 ...
 * format for the simulation viewer.
 * @param path_results string containing the path to the results folder.
 * @param txt_filename string containing the .txt filename.
 * @return 0 if the function ran successfully. Otherwise, it returns an error
 * code.
 */
 ...
 * format for the simulation viewer.
 * @param path_results string containing the results folder path containing the
 * simulation results.
 * @return 0 if the function ran successfully. Otherwise, it returns an error
 * code.
 */
