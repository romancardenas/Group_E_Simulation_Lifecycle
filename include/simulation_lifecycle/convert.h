...
/**
 * @brief Converts irregular cell-DEVS simulation results .json file into the required
...
/**
 * @brief Converts irregular cell-DEVS simulation results .txt file into the required
 * format for the simulation viewer.
 * @param[in] path_results string containing the path to the results folder.
...
/**
 * @brief Converts irregular cell-DEVS simulation results files into the required
 * format for the simulation viewer.
